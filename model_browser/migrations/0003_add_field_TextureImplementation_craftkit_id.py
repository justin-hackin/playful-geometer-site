...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TextureImplementation.craftkit_id'
        db.add_column(u'model_browser_textureimplementation', 'craftkit_id',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=6),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TextureImplementation.craftkit_id'
        db.delete_column(u'model_browser_textureimplementation', 'craftkit_id')
