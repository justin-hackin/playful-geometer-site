...
def texture_implementations_for_polyhedron(polyhedron_slug):
    return TextureImplementation.objects.filter(is_active=True, polyhedron_mapped_to__slug=polyhedron_slug)
